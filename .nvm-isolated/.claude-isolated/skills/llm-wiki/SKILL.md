---
name: llm-wiki
description: Поддержка и развитие базы знаний (вики) — извлечение, синтез и поддержка wiki из raw-источников.
user-invocable: true
context: fork
...
Скилл реализует паттерн формирования и поддержания вики для Obsidian vault: вместо поиска по сотням сырых файлов — компаундируемая wiki-база знаний, которую LLM поддерживает автоматически.
