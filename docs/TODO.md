...
| iwiki-plugin-to-mcp | in-progress | n/a | ✓ | – | – | 2026-06-30 |  | Migrate iwiki usage to MCP server + decommission in-repo plugin integration; spec opens the chain (no intent); check-spec OK (4/4 phases passed, 0 findings) |
