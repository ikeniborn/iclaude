...
> **Module:** `context` | **File:** `lib/context/memory.sh`
...
Initialize MEMORY.md with best practices template Creates structured MEMORY.md following Anthropic guidelines
...
Validate MEMORY.md against best practices Checks size, structure, and language clarity
...
Organize MEMORY.md - suggest topic files Analyzes content and recommends split into topic files
...
Add entry to MEMORY.md Appends new entry with auto-validation
...
Auto Memory status Shows MEMORY.md size, usage, topic files, commands
