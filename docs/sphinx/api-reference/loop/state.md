...
> **Module:** `loop` | **File:** `lib/loop/state.sh`
...
Save loop state to JSON file Creates checkpoint file for recovery after interruption
...
Load loop state from file Restores execution state after crash or interruption
