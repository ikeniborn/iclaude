...
> **Module:** `loop` | **File:** `lib/loop/parser.sh`
...
Load a single task from Markdown file Parses task metadata from structured Markdown format
...
Load all tasks from Markdown file Supports multiple "# Task:" sections in one file
