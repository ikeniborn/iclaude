# Graph Report - iclaude  (2026-05-08)

## Corpus Check
- 54 files · ~82,362 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2123 nodes · 2186 edges · 154 communities (152 shown, 2 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `990ec9b3`
...
## Communities (154 total, 2 thin omitted)
...
Cohesion: 0.05
Nodes (51): Architecture Documentation Skill, Brainstorming Skill, Caveman JS Hooks, Caveman Integration Design, Caveman Token Compression Integration, Caveman Upstream Repository, Context Awareness Graph Integration Design, Graph Integration into Skills (+43 more)
...
Cohesion: 0.25
Nodes (7): code:block1 (Создать:), code:markdown (# Upstream Issue / PR Tracker), code:bash (gh issue create --repo safishamsi/graphify --web), code:bash (git add lib/graphify/UPSTREAM_ISSUE.md), File Map, Graphify Portability v2: Patch graphifyy Implementation Plan, Task 10: Создать UPSTREAM_ISSUE.md
...
## Knowledge Gaps
- **1296 isolated node(s):** `Validate upstream URL: must be HTTPS or loopback HTTP (prevents SSRF via file://`, `Return this thread's requests.Session, creating it on first access.`, `Configure 'pii-proxy' logger directly (not root logger) for reliability.`, `Detect installed spaCy models from venv marker files or by probing spacy.      R`, `Lazy-initialize Presidio NLP engine with all available language models.      Thr` (+1291 more)
...
- **Why does `Claude Statusline Documentation` connect `Community 67` to `Community 89`, `Community 131`, `Community 38`, `Community 104`, `Community 73`, `Community 105`, `Edge Case Redaction Tests`, `Community 74`, `Community 81`, `Community 147`, `Community 115`, `Community 25`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `launch_claude` connect `PII Detector Tests` to `Community 51`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Troubleshooting` connect `Community 74` to `Community 67`?**
