...
# NOTE: The following are now loaded from lib/core/ modules:
# - Colors (RED, GREEN, YELLOW, BLUE, NC) - from lib/core/init.sh
# - Constants (SCRIPT_DIR, CREDENTIALS_FILE, etc.) - from lib/core/init.sh (via init_environment())
# - print_info(), print_success(), print_warning(), print_error() - from lib/core/logging.sh
#
# This file will be gradually phased out as modules are extracted (Phase 1-9)
#######################################

# COMMENTED OUT - Now loaded from lib/core/init.sh and lib/core/logging.sh
# # Colors for output
# RED='\033[0;31m'
# GREEN='\033[0;32m'
# YELLOW='\033[1;33m'
